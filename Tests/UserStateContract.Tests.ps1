...
Assert-Contains -Text $userStateText -ExpectedSubstring "var focusTrack: FocusTrack" -Message "App user state should persist focus-track preference."
...
Assert-Contains -Text $storeText -ExpectedSubstring "func setFocusTrack(_ focusTrack: FocusTrack)" -Message "Local user-state store should persist focus-track updates."
...
Assert-Contains -Text $settingsText -ExpectedSubstring "Binding(" -Message "Settings should bind focus language to persisted state."

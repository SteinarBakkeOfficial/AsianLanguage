...
Assert-True $browse.Contains("CollectionsView.catalog(for: dependencies)") "Browse must render the shared editorial collection catalog."
Assert-True $browse.Contains("EditorialCollectionDetailView") "Browse collection panels must open their matching collection."

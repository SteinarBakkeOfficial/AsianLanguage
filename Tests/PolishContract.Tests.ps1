...
Assert-Contains -Text $settingsText -ExpectedSubstring "About Script Roots" -Message "Settings should expose the app information page."
Assert-Contains -Text $settingsText -ExpectedSubstring "AboutMethodView" -Message "Settings should route to the app information page."

...
大 is taught here from its original idea: a person with arms and legs spread wide, used for the idea big/great.
...
The Origin visual state is currently unavailableAsset. Missing material must remain explicit until an approved local asset is added.

# Educational origin illustration brief: 少
...
Illustrate the concrete object, action, body form, or meaningful scene behind the earliest defensible story for 少. The composition must be understandable as a real-world referent first, then visually echo the silhouette, arrangement, or meaningful parts documented in the historical evidence. The learner should be able to compare this illustration with the separately displayed earliest glyph and understand the proposed transition without the illustration pretending to be the glyph.

## Source cues

Grains of sand; 小 provides the pronunciation and meaning / Pictograph of four small dots, representing grains of sand or rice, to convey the meaning "less". Similar to 小. / 不多也。从小丿聲。 / Pictogram (象形) – four dots, perhaps three grains of sand (see 沙), to indicate "a few, a little". Phonetically borrowed from 小 (OC *smewʔ, “small”), which is depicted by three dots.

...
- Teaching rank: 53
- Primary collection: Qualities, Relations & Abstract Ideas
- Formation screen: pictographic
- IDS / structure: 贝
- Aggregated confidence: 61
- Verification status: cross-verified
- Japanese reading field: 
- Korean Hanja reading field: 

## Current visual-story evidence

A sea shell, once used as currency / Simplified form of 貝.  Pictograph of a cowrie shell. In ancient China such shells were used as currency. / Simplified form of 貝 in cursive script.
...
- **clerical**: 1 indexed reference(s); representative files are listed in historical-references.json.
- **seal**: 2 indexed reference(s); representative files are listed in historical-references.json.

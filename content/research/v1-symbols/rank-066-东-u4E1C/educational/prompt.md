# Educational origin illustration brief: 东
...
Illustrate the concrete object, action, body form, or meaningful scene behind the earliest defensible story for 东. The composition must be understandable as a real-world referent first, then visually echo the silhouette, arrangement, or meaningful parts documented in the historical evidence. The learner should be able to compare this illustration with the separately displayed earliest glyph and understand the proposed transition without the illustration pretending to be the glyph.

## Source cues

Simplified form of 東, the sun 日 rising behind a tree 木 / Pictograph of a basket or a bag. The current meaning "east" is a phonetic loan. The simplified character 东 was adapted from the cursive form of the traditional character 東. / From cursive script of 東 /东 (dōng); compare 車 → 车.
